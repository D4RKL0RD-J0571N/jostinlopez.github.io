                ...
                <div className="grid md:grid-cols-12 gap-12 items-start">
                    ...
                    >
                        <div className="flex flex-col md:flex-row gap-8 items-start mb-12">
                            {/* Profile Image with status - MOVED HERE */}
                            <div className="relative group shrink-0 w-32 md:w-40 aspect-square">
                                ...
                                <div className="w-full h-full bg-bg-base rounded-xl overflow-hidden relative border border-bg-elevated">
                                    ...
                                    />
                                    {/* System Status Indicator - Compact Version */}
                            ...
                            <div className="space-y-6">
                                <h2 className="text-3xl font-bold border-l-4 border-accent pl-4 text-text-primary">
                                    {t('about.title')}
                                </h2>
                        ...
                        {/* Core Competencies - MOVED DIRECTLY UNDER BIO */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {skills.map((skill, idx) => (
                                <Card key={idx} className="p-4 hover:-translate-y-1 h-full flex flex-col justify-between">
                                    <div className="text-accent mb-3 transition-transform group-hover:scale-110 origin-left">{skill.icon}</div>
                                    <div>
                    ...
                    {/* Right Column / Decorative or Additional Info - (Timeline removed from here) */}
